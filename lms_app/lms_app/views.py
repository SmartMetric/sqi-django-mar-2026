...
def dashboard(request):
    context = {
        ...
        "weekend_greeting": "Happy Weekend! Enjoy your reading time at the library.",
        "weekday_greeting": "Welcome to the library! Explore our collection and find your next great read."
